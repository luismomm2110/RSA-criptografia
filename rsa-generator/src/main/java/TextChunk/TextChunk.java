...
/**
 * A TextChunk is a string that can be viewed as either a Java String or as a
 * BigInteger encoding the 8-bit characters in the string as a giant integer
 * value. Either view can be used to construct a new TextChunk. The characters
 * in the string must be ISO Latin-1 8-bit characters with int values in the
 * range 0 to 255. No checking is done to verify this condition.
 * 
 * @author Hal Perkins
 * @version 10/30/01
 */
public class TextChunk {
	...
	/**
	 * Return number of Latin-1 (8-bit) characters that can be encoded in a big
	 * integer < N. Utility function for RSA encoding.
	 */
